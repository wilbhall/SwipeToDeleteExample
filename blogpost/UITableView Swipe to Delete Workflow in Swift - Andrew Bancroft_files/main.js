...
function pageLoaded() 
{
	...
	console.log("300x250 Ad version: " + adVersion);
...
function initMainAnimations()
{
	...
	tl.to($("#ctaTriangleLeft"), dockCTADuration, {left:14, top:129, ease:Power1.easeInOut}, "dockCTA");
	tl.to($("#ctaParallelogram"), dockCTADuration, {left:14, top:129, ease:Power1.easeInOut}, "dockCTA");
	tl.to($("#ctaTriangleRight"), dockCTADuration, {left:112, top:128, ease:Power1.easeInOut}, "dockCTA");
